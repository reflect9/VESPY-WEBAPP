Vespy.planner = {
		...
		string_test: {
			...
			execute: function(O) {
				try {
					...
					var source = Vespy.Node.getParamValue(O,"source");
					var key_list = _.union([], Vespy.Node.getParamValue(O,"key"));
	...
	get_options : function(pType, paramKey) {
		var parameters = Vespy.planner.operations[pType].parameters;
